...
## Project status
As of 26.04.2026: Code for throttle and wheelie mode implemented. Compiles and runs. Tested handheld on a VESCed Onewheel Pint by author. Tested to some extent on mini-bikes by other users. More testing and tuning needed.